...
const NavBar = ({ children, user, onLogout, menuItems, logoUrl, systemTitle, onNavigate, applications, currentAppId }) => {
    ...
    return (jsxRuntime.jsxs("div", { className: "app-container", children: [jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(SideMenu, { user: showUser, isCollapsed: isSidebarCollapsed, onToggleCollapse: handleToggleSidebar, menuItems: menuItems, logoUrl: logoUrl, systemTitle: systemTitle, onNavigate: onNavigate }), jsxRuntime.jsx(reactBootstrap.Navbar, { bg: "dark", variant: "dark", className: `top-navbar ${isSidebarCollapsed ? 'sidebar-collapsed' : ''}`, children: jsxRuntime.jsx(reactBootstrap.Nav, { className: "ms-auto", children: jsxRuntime.jsxs("div", { className: "user-info-header", children: [jsxRuntime.jsxs(reactBootstrap.Dropdown, { show: showAppSwitcher, onToggle: (isOpen) => setShowAppSwitcher(isOpen), className: "app-switcher-dropdown", children: [jsxRuntime.jsx(reactBootstrap.Dropdown.Toggle, { variant: "link", className: "app-switcher-toggle", id: "app-switcher-dropdown", children: jsxRuntime.jsx("i", { className: "fa-solid fa-grip", "aria-hidden": "true" }) }), jsxRuntime.jsxs(reactBootstrap.Dropdown.Menu, { className: "app-switcher-menu", children: [jsxRuntime.jsx("div", { className: "app-switcher-header", children: jsxRuntime.jsx("h6", { children: "WEB APPLICATIONS" }) }), jsxRuntime.jsx("div", { className: "app-grid", children: apps.map((app) => (jsxRuntime.jsxs("a", { href: app.url, className: `app-item ${currentAppId === app.id ? 'active' : ''}`, onClick: (e) => {
                                                                if (app.url === '#') {
                                                                    e.preventDefault();
                                                                }
                                                                setShowAppSwitcher(false);
                                                            }, target: "_blank", rel: "noopener noreferrer", children: [jsxRuntime.jsx("div", { className: "app-icon", style: { backgroundColor: app.color || '#ff8c42' }, children: jsxRuntime.jsx("i", { className: `fa-solid fa-${app.icon}` }) }), jsxRuntime.jsx("span", { className: "app-name", children: app.name })] }, app.id))) })] })] }), jsxRuntime.jsx("div", { className: "user-details-nav", children: jsxRuntime.jsxs("span", { className: "user-name", children: ["Hola, ", showUser.given_name && showUser.family_name ? `${showUser.given_name} ${showUser.family_name}` : (showUser.given_name || showUser.name)] }) }), jsxRuntime.jsx(reactBootstrap.Button, { onClick: handleLogout, className: "logout-btn-header", children: !isMobile && jsxRuntime.jsx("span", { className: "ms-2", children: " Cerrar sesi\u00F3n" }) })] }) }) })] }), jsxRuntime.jsx("main", { className: `main-content with-navbar ${isSidebarCollapsed ? 'sidebar-collapsed' : ''}`, children: children })] }));
};
